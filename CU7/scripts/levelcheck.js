...
system.runInterval(() => {
    ...
    for (const player of world.getAllPlayers()) {
        if ((score.getScore(player) >= 10) && !player.hasTag('l1')) {
            ...
            player.runCommand('playsound random.bell @a[scores={sound=!2}]');
        }
            ...
            player.runCommand('playsound random.levelup @a[scores={sound=!2}]');
        }
            ...
            player.runCommand('playsound mob.enderdragon.growl @a[scores={sound=!2}]');
        }
