...
world.afterEvents.entityDie.subscribe(({ damageSource: { damagingEntity }, deadEntity }) => {
  ...
  if (deadEntity.typeId === 'minecraft:ender_dragon') {
     ...
     damagingEntity.runCommand('scoreboard players add @s[rm=3, r=100, hasitem={item=mace, quantity=0}] points 5000');
  ...
  // LEVEL 2
     ...
     damagingEntity.runCommand('scoreboard players add @s[rm=3, r=100] points 10');
     damagingEntity.runCommand('scoreboard players add @s[rm=3, r=100] score 2');
  }
  ...
  // LEVEL 3
     ...
     damagingEntity.runCommand('scoreboard players add @s[rm=3, r=100] points 25');
     damagingEntity.runCommand('scoreboard players add @s[rm=3, r=100] score 5');
  }
  ...
  // LEVEL 4
     ...
     damagingEntity.runCommand('scoreboard players add @s[rm=3, r=100] points 50');
     damagingEntity.runCommand('scoreboard players add @s[rm=3, r=100] score 10');
  }
  ...
  // LEVEL 5
     ...
     damagingEntity.runCommand('scoreboard players add @s[rm=3, r=100] points 100');
     damagingEntity.runCommand('scoreboard players add @s[rm=3, r=100] score 20');
  }
