...
execute at @p[tag=rank1, tag=!rank1done] run playsound random.levelup @a[scores={sound=0}]
execute at @p[tag=rank2, tag=!rank2done] run playsound random.levelup @a[scores={sound=0}]
